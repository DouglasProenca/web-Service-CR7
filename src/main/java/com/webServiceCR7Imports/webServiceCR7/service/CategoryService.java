...
public interface CategoryService {
	...
	@GetMapping("/{id}")
	Optional<CategoryResponse> findOne(@PathVariable Integer id);

	@DeleteMapping("/{id}")
	String delete(@PathVariable Integer id);

	@PutMapping(value = "/{id}")
	CategoryResponse update(@PathVariable Integer id, @RequestBody CategoryRequest categoryRequestUpdate);
